...
# def add_highlighted_soma(clustered_barcodes, soma_seg_ids, soma_id):
#     """Add a highlighted soma to the heatmap."""
#     # get the index of the soma_id
#     soma_index = soma_seg_ids.index(soma_id)
#     # add a red rectangle to the heatmap
#     ax_heatmap.add_patch(plt.Rectangle((0, soma_index), data_width, height, fill=False, edgecolor='red', linewidth=0.5))
...
if __name__ == "__main__":
    ...
    orientation = "horizontal"
    output_filename = f"hierarchical_clustering_{orientation}_square.png"
    ...
    for highlight in highlights:
        ...
        rect = patches.Rectangle(
            # (highlight_index - 0.5, ymin),  # -0.5 to center over the tick
            (highlight_index, ymin),  # -0.5 to center over the tick
            x_width,
            ymax - ymin,
            # facecolor='red',
            edgecolor="red",
        ...
        ax.text(
            highlight_index,  # x position (numerical index)
            ymin - (ymax - ymin) * 0.02,  # slightly below the axis
